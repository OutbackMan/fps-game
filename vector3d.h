...
float vector3d_length(struct Vector3D *input_vector);

void vector3d_change_all_coordinates(struct Vector3D *input_vector, float x, float y, float z);
void vector3d_change_x_coordinate(struct Vector3D *input_vector, float x);
void vector3d_change_y_coordinate(struct Vector3D *input_vector, float y);
void vector3d_change_z_coordinate(struct Vector3D *input_vector, float z);
...
bool vector3d_is_equal(struct Vector3D *input_vector1, struct Vector3D *input_vector2);
bool vector3d_is_equal(struct Vector3D *input_vector1, struct Vector3D *input_vector2);
